...
class StatusBarCompatKitKat {
    ...
    private static View addFakeStatusBarView(Window window, int statusBarColor, int statusBarHeight) {
        ViewGroup mDecorView = (ViewGroup) window.getDecorView();

        View mStatusBarView = new View(window.getContext());
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, statusBarHeight);
        layoutParams.gravity = Gravity.TOP;
        mStatusBarView.setLayoutParams(layoutParams);
        mStatusBarView.setBackgroundColor(statusBarColor);
     ...
     */
    private static void addMarginTopToContentChild(View mContentChild, int statusBarHeight, boolean below) {
...
//                lp.topMargin = 0;
    ...
    static void setStatusBarColor(Window window, int statusColor, boolean below) {
        ...
        addFakeStatusBarView(window, statusColor, statusBarHeight);
        addMarginTopToContentChild(mContentChild, statusBarHeight, below);
