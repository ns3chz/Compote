...
//    private ReflectTools() throws Exception {
...
//    }
    ...
    <T> T newInstance(@NonNull Object object, Class<?>[] classArr, Object... params) {
     ...
     */
    public static @Nullable
    <T> T newInstance(@NonNull Class<T> clazz, Class<?>[] classArr, Object... params) {
     ...
     */
    public static @Nullable
    <T> T newInstance(@NonNull Constructor constructor, Object... params) {
     ...
     */
    public static @Nullable
    <T> T call(@NonNull Object obj, String methodName, Class<?>[] fieldClasses, Object... fields) {
     ...
     */
    public static @Nullable
    <T> T call(@NonNull Object obj, @NonNull Class<?> clazz, @NonNull String methodName, Class<?>[] fieldClasses, Object... fields) {
        Method method;
        try {
     ...
     */
    public static @Nullable
    <T> T getField(@NonNull Object obj, @NonNull String fieldName) {
     ...
     */
    public static @Nullable
    <T> T getField(@NonNull Object obj, @NonNull Class<?> clazz, @NonNull String fieldName) {
        if (fieldName.length() == 0) return null;
        Field field;
        try {
